package com.coding.problem.java.CountDuplicateCharacters;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Map<Character, Integer> duplicatesV1 = CountDuplicates.countDuplicateCharactersV1(TEXT);
        ...
        Map<Character, Long> duplicatesV2 = CountDuplicates.countDuplicateCharactersV2(TEXT);
        ...
        Map<String, Integer> duplicatesV3 = CountDuplicates.countDuplicateCharactersVCP1(TEXT_CP);
        ...
        Map<String, Long> duplicatesV4 = CountDuplicates.countDuplicateCharactersVCP2(TEXT_CP);
